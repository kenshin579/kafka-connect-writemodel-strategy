...
val projectArchiveBaseName = "kafka-connect-writemodel-upsert-0.0.1" // Set the outputted jar base name
val mongoKafkaConnectVersion = "1.7.0" // Set the mongo kafka connect version
